  ...
  return (
    <>
      ...
      <main className="flex-1 container px-4 sm:px-8 py-6 space-y-6 max-w-7xl mx-auto pb-24 md:pb-12">
        {/* Local storage migration prompt */}
        {pendingLocalMigrationCount > 0 && user && (
          <div className="p-4 rounded-2xl bg-amber-500/15 border border-amber-500/30 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                <h4 className="text-sm font-semibold text-foreground">
                  Migrate {pendingLocalMigrationCount} Offline Words to Supabase
                </h4>
                <p className="text-xs text-muted-foreground">
                  We found words saved locally on this browser. Would you like to upload them to your cloud account?
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    await migrateLocalWordsToCloud();
                  } catch (e) {
              ...
              <div className="flex items-center gap-2">
                ...
                {user?.email && (
                  <Badge variant="outline" className="text-[11px] text-emerald-600 dark:text-emerald-400 border-emerald-500/30 bg-emerald-500/10">
                    <Icons.Check size={12} className="mr-1" /> Synced to Supabase
                  </Badge>
                )}
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative w-full">
            ...
            <Input
              ...
              className="pl-10 h-11 text-sm bg-card/70 w-full"
            />
            {searchQuery && (
              <button
                type="button"

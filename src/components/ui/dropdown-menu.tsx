...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-lg px-2.5 py-1.5 text-xs font-medium outline-none transition-colors focus:bg-accent/15 focus:text-accent data-[disabled]:pointer-events-none data-[disabled]:opacity-50 gap-2",
      inset && "pl-8",
      className
    )}
    {...props}
